package com.witts.mdbox.util.api;
...
//    public static final String BASE_URL = "http://139.59.248.59/";
    public static final String QA_LIST_API_URL = "json/device/qalist";

    public static final String MAIN_MENU_ENQUIRY_URL = "json/device/main-menu-enquiry";

    public static final String MESSAGE_LIST_ENQUIRY_URL = "json/device/messages";
